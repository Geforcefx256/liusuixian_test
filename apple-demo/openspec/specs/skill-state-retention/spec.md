# skill-state-retention Specification

## Purpose
Define the runtime guarantees for reconstructing retained skill state from persisted session history and reinjecting that state after conversation compaction.
