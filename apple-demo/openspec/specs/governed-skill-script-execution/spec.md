# governed-skill-script-execution Specification

## Purpose
Define how approved canonical skill packages declare, expose, validate, and execute governed script templates.
## Requirements
